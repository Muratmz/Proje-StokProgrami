...
# Form implementation generated from reading ui file 'kayitlariGor.ui'
#
...
"    background-color: #ffffff;\n"
"}")
        self.cwKayitlar = QtWidgets.QCalendarWidget(Form)
        self.cwKayitlar.setGeometry(QtCore.QRect(30, 50, 392, 236))
        self.cwKayitlar.setObjectName("cwKayitlar")
        self.label = QtWidgets.QLabel(Form)
        self.label.setGeometry(QtCore.QRect(80, -20, 291, 81))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btnKayitlarGOR = QtWidgets.QPushButton(Form)
        self.btnKayitlarGOR.setGeometry(QtCore.QRect(180, 290, 93, 28))
        self.btnKayitlarGOR.setObjectName("btnKayitlarGOR")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Kayıtlar"))
        self.label.setText(_translate("Form", "Görmek istediğiniz günün kayıtları için tarih seçin ve Kayıtları Gör butonuna basınız"))
        self.btnKayitlarGOR.setText(_translate("Form", "Kayıtları Gör"))
